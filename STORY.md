...
To get stable Ethernet (W5500), I had to use outdated, unmaintained libraries. I was stuck in an old IDE version, afraid to update anything because the whole stack might collapse.
<br/><br/>

⛔ The Lock-Out:

The system would hang at the worst possible moments. I spent two hours waiting in front of my own house because the "Smart" system refused to open the door and I didn't have a physical key on me.
<br/><br/>
